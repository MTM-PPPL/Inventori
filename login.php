...
<head>
    ...
    <title>Sistem Inventaris Barang PT. DHK</title>

    <!-- Atur Tampilan -->
    <link href="css/bootstrap.min.css" rel="stylesheet">
    <style>
        body {
            background: url(img/gambar-bg.jpg) no-repeat fixed;
            ...
            <div class="center">
                <div class="login">
                    <form role="form" action="" method="post">
                        <img src="../inventori_dhk/img/logocompp.png" style="width:100px;height:85px;">
                        <h3>Sistem Inventaris Barang PT. DHK</h3>
