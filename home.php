...
<div class="container-fluid">
  ...
  <marquee>
    <h2 class="font-weight-bold">Halo, Selamat Datang <?php echo $data['nama']; ?>! Selamat Bertugas & Selalu Jaga Kesehatan</h2>
  </marquee>
  <br></br>
