  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index3.php">
        ...
        <!-- <div class="sidebar-brand-text mx-2">PT. DHK</div> -->
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="?halaman=home3">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <section class="content">
            ...
            if ($halaman == "pengguna") {
              if ($aksi == "") {
                include "halaman/pengguna/pengguna.php";
              }
              if ($aksi == "tambahpengguna") {
                include "halaman/pengguna/tambahpengguna.php";
              }
              if ($aksi == "ubahpengguna") {
                include "halaman/pengguna/ubahpengguna.php";
              }
              if ($aksi == "hapuspengguna") {
                include "halaman/pengguna/hapuspengguna.php";
              }
            }
